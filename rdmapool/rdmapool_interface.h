 ...
 */
DEFINE_GUID(GUID_DEVINTERFACE_RDMAPOOL,
    0x7b5e2f3a, 0x9c1d, 0x4e8f,
    0xa6, 0xb2, 0x3d, 0x4c, 0x5e, 0x6f, 0x7a, 0x8b);
...
#define IOCTL_RDMAPOOL_ALLOCATE \
    CTL_CODE(FILE_DEVICE_RDMAPOOL, 0x800, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_RDMAPOOL_FREE \
    CTL_CODE(FILE_DEVICE_RDMAPOOL, 0x801, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_RDMAPOOL_QUERY_POOL \
    CTL_CODE(FILE_DEVICE_RDMAPOOL, 0x802, METHOD_BUFFERED, FILE_ANY_ACCESS)
 ...
 *   Output: None
 */
#define IOCTL_RDMAPOOL_RESERVE \
    CTL_CODE(FILE_DEVICE_RDMAPOOL, 0x803, METHOD_BUFFERED, FILE_ANY_ACCESS)
